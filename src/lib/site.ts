...
export const site = {
  ...
  description:
    "Edit videos online for free with Auto Edit. Cut clips, add captions, transitions, music and more directly in your browser.",
  url: SITE_URL,
  socialImage: `${SITE_URL}/og-auto-edit.jpg`,
...
/** Builds route-level head() meta + canonical link for a public page. */
